...
public class TestPorterStemmer {
    ...
    public void testStemFiles() throws IOException {
        BufferedReader inputReader = new BufferedReader(new FileReader("src/test/resources/input.txt"));
        BufferedReader expectedOutputReader = new BufferedReader(new FileReader("src/test/resources/output.txt"));
